    ...
    <div class="center-website">
        <div class="logo-website">
            ...
            <div id="nav-website">
                ...
                <div class="button-nav-website"><a href="?page=art">obrazy</a></div>
...
<nav class="navbar navbar-expand-lg fixed-top  navbar-dark bg-dark" id="navbar">
    ...
    <button class="navbar-toggler border-0" type="button" data-toggle="collapse" data-target="#navbarToggler" aria-controls="navbarToggler" aria-expanded="false" aria-label="Toggle navigation" style="outline:none; box-shadow:none;">
